 ...
 *
 * Each slide needs `href`, `img`, `alt`, `series` (small label) and `title`
 * (the headline) — the Hero.twig partial renders both the slide and its
 * matching desktop tab from the same entry, so there is only one place to
 * edit per slide.
 */
class HeroConfig
{
